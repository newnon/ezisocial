...
public:
    ...
    virtual void fbSendRequestCallback(int responseCode, const char* responseMessage, const std::vector<std::string> &friendsGotRequests) {}
    ...
    virtual void fbFriendsCallback(int responseCode, const char* responseMessage, const cocos2d::Vector<EziFacebookFriend*> &friends) {}
    virtual void fbHighScoresCallback(int responseCode, const char* responseMessage, const cocos2d::Vector<EziFacebookFriend*> &highScores) {}
